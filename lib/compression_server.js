...
function buildInvoicePdfBuffer(transaction) {
  ...
  var lines = [
    ...
    'Base Price: ' + currencyLabel + baseAmount.toFixed(2),
    '18% GST (Included): ' + currencyLabel + taxAmount.toFixed(2),
    'Total Amount Paid: ' + currencyLabel + totalPaid.toFixed(2) + ' (Inclusive of all taxes)',
    'Status: ' + (transaction.status || 'paid'),
    'Issued: ' + (transaction.createdAt || new Date().toISOString()),
    '',
    'This is a computer-generated invoice and does not require a physical signature. For any queries or discrepancies, please contact hello@getreadyjob.com.'
  ];
  var content = '';
