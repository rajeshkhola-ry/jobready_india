...
function readPlanCatalogState() {
  try {
    ...
    return {
      ...
      voice_quotas_by_plan: (parsed.voice_quotas_by_plan && typeof parsed.voice_quotas_by_plan === 'object') ? parsed.voice_quotas_by_plan : {}
    };
  } catch (err) {
...
app.post('/api/admin/plan-catalog', requireAdmin, function (req, res) {
  ...
  var next = {
    ...
    voice_quotas_by_plan: (payload.voice_quotas_by_plan && typeof payload.voice_quotas_by_plan === 'object')
      ? payload.voice_quotas_by_plan
      : planCatalogConfig.voice_quotas_by_plan
  };
