...
// Generic conversion endpoint - currently PDF -> Image (JPG/PNG) pages as a
// ZIP archive, rasterized server-side via Ghostscript so large/complex PDFs
// never need to be rendered in browser memory.
