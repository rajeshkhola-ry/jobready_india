...
function buildInvoicePdfBuffer(transaction) {
  ...
  addText('Get Ready Job - Tax Invoice / Receipt', 14, { align: 'center', gap: 46 });
  ...
  addText('Customer State: ' + (billing.state ? billing.state : (billing.country ? billing.country : 'India')), 10, { gap: 50 });
  ...
  addRow('18% GST', currencyLabel + taxAmount.toFixed(2), 10, 22);
  addRule(26);
