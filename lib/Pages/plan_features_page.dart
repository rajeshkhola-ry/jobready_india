    ...
    return FutureBuilder<Map<String, dynamic>>(
      ...
      builder: (context, snapshot) {
        ...
        final combinedRows = <_PlanFeature>[
          ...
          _PlanFeature(
            name: 'Voice Commands Quota (Max 20s / Command)',
            free: true,
            sevenDay: true,
            monthly: true,
            yearly: true,
            ...
            sevenDayValue: voiceQuotaValues['7 DAYS']?.isNotEmpty == true ? voiceQuotaValues['7 DAYS'] : '25',
            monthlyValue: voiceQuotaValues['MONTHLY']?.isNotEmpty == true ? voiceQuotaValues['MONTHLY'] : '150',
            yearlyValue: voiceQuotaValues['YEARLY']?.isNotEmpty == true ? voiceQuotaValues['YEARLY'] : '1500',
            lifetimeValue: voiceQuotaValues['LIFETIME']?.isNotEmpty == true ? voiceQuotaValues['LIFETIME'] : '5000',
          ),
          _PlanFeature(
