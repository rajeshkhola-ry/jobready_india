...
class _SystemCheckPageState extends State<SystemCheckPage> {
  ...
  Widget _heroCard() {
    return Container(
      ...
      child: Row(
        children: const [
          Icon(Icons.dashboard_customize_rounded, color: Color(0xFF0E3A66), size: 24),
          SizedBox(width: 12),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  'Review the smoke matrix, readiness states, and launch tools from one V2-style admin surface.',
                  style: TextStyle(
                    fontSize: 13,
                    height: 1.45,
                    color: Color(0xFF475569),
